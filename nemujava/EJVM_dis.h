  ...
  switch(tOpcode) {
      ...
      case 0xBA:   dis_???(loc,opcode);  break;  // ???
      ...
      case 0xDC:   dis_???(loc,opcode);  break;  // ???
      ...
      case 0xE5:   dis_???(loc,opcode);  break;  // ???
      case 0xE6:   dis_???(loc,opcode);  break;  // ???
      case 0xE7:   dis_???(loc,opcode);  break;  // ???
      case 0xE8:   dis_???(loc,opcode);  break;  // ???
      case 0xE9:   dis_???(loc,opcode);  break;  // ???
      case 0xEA:   dis_???(loc,opcode);  break;  // ???
      case 0xEB:   dis_???(loc,opcode);  break;  // ???
      case 0xEC:   dis_???(loc,opcode);  break;  // ???
      case 0xED:   dis_???(loc,opcode);  break;  // ???
      case 0xEE:   dis_???(loc,opcode);  break;  // ???
      case 0xEF:   dis_???(loc,opcode);  break;  // ???
      case 0xF0:   dis_???(loc,opcode);  break;  // ???
      case 0xF1:   dis_???(loc,opcode);  break;  // ???
      case 0xF2:   dis_???(loc,opcode);  break;  // ???
      case 0xF3:   dis_???(loc,opcode);  break;  // ???
      case 0xF4:   dis_???(loc,opcode);  break;  // ???
      case 0xF5:   dis_???(loc,opcode);  break;  // ???
      case 0xF6:   dis_???(loc,opcode);  break;  // ???
      case 0xF7:   dis_???(loc,opcode);  break;  // ???
      case 0xF8:   dis_???(loc,opcode);  break;  // ???
      case 0xF9:   dis_???(loc,opcode);  break;  // ???
      case 0xFA:   dis_???(loc,opcode);  break;  // ???
      case 0xFB:   dis_???(loc,opcode);  break;  // ???
      case 0xFC:   dis_???(loc,opcode);  break;  // ???
      case 0xFD:   dis_???(loc,opcode);  break;  // ???
